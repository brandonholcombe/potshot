...
| M2 | FishNet netcode | 🚧 In progress | m2a-c netcode ✅, ui/menus ✅, LOBBY system ✅ (warmup pen, leader controls, match lifecycle — LIVE), fire-feel tracer ✅ (v0.2.0); next: identity/juice, m2d harness, networked pickups, M4 hardening |
