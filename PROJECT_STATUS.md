...
| M1 | Core game offline: tank controller, projectiles, 3–4 weapons, 1 arena, bots | 🚧 In progress | Slices a (tank movement, m1c) + b (weapons/damage, m1d) ✅; next: c (pickups/ammo), d (bots + FFA + respawn) |
